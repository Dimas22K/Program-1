...
<head>
  ...
  <title>Tambah Data Interval - Calibration Laboratory</title>
...
<body class="bg-gray-50 flex flex-col min-h-screen">
  ...
  <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-2xl mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-lg">
      ...
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-8">Tambah Interval Baru</h1>
      ...
      <form action="{{ route('interval.store') }}" method="post">
        ...
        <div class="mb-6">
          ...
          <input type="text" name="nama_alat" id="nama_alat" required class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: Digital Caliper">
        </div>

        <div class="mb-8">
          <label for="interval_bulan" class="block text-sm font-medium text-gray-700 mb-2">Interval (bulan)</label>
          <input type="number" name="interval_bulan" id="interval_bulan" required class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: 6">
        </div>
