...
<body class="bg-gradient-to-br from-cyan-200 via-teal-200 to-blue-300">
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        ...
        <div class="w-full max-w-lg mx-auto bg-white/80 backdrop-blur-sm shadow-2xl rounded-2xl p-8">
            ...
            <div class="mb-6">
                <a href="{{ url()->previous() }}" 
                   class="inline-flex items-center gap-2 rounded-lg px-3 py-1 font-semibold text-teal-700 hover:bg-teal-100 hover:text-teal-900 hover:-translate-x-1 transition-all duration-300 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" 
                         viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-5 h-5">
            ...
            <h2 class="text-3xl font-bold mb-8 text-center text-teal-800">
                Update Measuring Instrument Data
            </h2>
