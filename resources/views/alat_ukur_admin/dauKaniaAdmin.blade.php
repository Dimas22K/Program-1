...
<head>
    ...
    <title>Merchant Ship Measuring Instruments Data - Admin</title>
...
<body class="bg-slate-100 font-sans">
    ...
    <div class="container mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-3xl font-bold mb-6 text-slate-800">Merchant Ship Measuring Instruments Data (Admin)</h1>
