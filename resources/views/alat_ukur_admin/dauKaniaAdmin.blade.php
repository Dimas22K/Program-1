...
<head>
    ...
    <title>Kania Measuring Instrument Data - Admin</title>
...
<body class="bg-slate-100 font-sans">
    ...
    <div class="container mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-3xl font-bold mb-6 text-slate-800">Kania Measuring Instrument Data (Admin)</h1>
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <table class="w-full table-fixed">
                <thead class="bg-slate-800 text-white">
                    <tr>
                        {{-- REFINED: Set specific percentage widths to make the table fit the screen --}}
                        ...
                        <th class="w-[12%] px-2 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Tool Name</th>
                        <th class="w-[12%] px-2 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Brand / Type</th>
                        <th class="w-[11%] px-2 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Serial Number</th>
                        <th class="w-[7%] px-2 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Range</th>
                        ...
                        <th class="w-[10%] px-2 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Calibration Plan</th>
                        <th class="w-[9%] px-2 py-3 border-b-2 border-slate-700 text-center text-xs font-semibold uppercase tracking-wider">Status</th>
                        <th class="w-[9%] px-2 py-3 border-b-2 border-slate-700 text-center text-xs font-semibold uppercase tracking-wider">Actions</th>
                    </tr>
                </thead>
