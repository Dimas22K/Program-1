...
<html>
<head>
    <title>Add Measuring Instrument</title>
...
<body class="bg-gradient-to-br from-cyan-200 via-teal-200 to-blue-300">
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        ...
        <div class="w-full max-w-lg mx-auto bg-white/80 backdrop-blur-sm shadow-2xl rounded-2xl p-8">
            ...
            <div class="mb-6">
                <a href="{{ url()->previous() }}" 
                   class="inline-flex items-center gap-2 rounded-lg px-3 py-1 font-semibold text-teal-700 
                          hover:bg-teal-100 hover:text-teal-900 hover:-translate-x-1 
            ...
            <form action="{{ route('admin.store', [$jenis, $divisi]) }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <select id="nama_alat" name="nama_alat" 
                            class="w-full mt-2 bg-white/70 border-2 border-cyan-200 rounded-lg py-2 px-3 
                                   ...
                                   transition duration-300 hover:border-teal-400" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="merk_type" name="merk_type" 
                               class="w-full mt-2 bg-white/70 border-2 border-cyan-200 rounded-lg py-2 px-3 
                                      focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 
                                      transition duration-300 hover:border-teal-400">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <select id="description" name="description"
                            class="w-full mt-2 bg-white/70 border-2 border-cyan-200 rounded-lg py-2 px-3 
                                   focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 
                                   transition duration-300 hover:border-teal-400" nullable>
                ...
                <button type="submit" 
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg 
                               shadow-lg font-semibold text-white bg-orange-500 
                               focus:outline-none focus:ring-2 focus:ring-offset-2 
                               focus:ring-offset-white/80 focus:ring-orange-500 
                               transition-all duration-300 ease-in-out 
                               hover:bg-orange-600 hover:-translate-y-1 hover:shadow-orange-500/40">
                    Save Data
                </button>
            </form>
        </div>
