...
<head>
    ...
    <title>Kaprang Measuring Instrument Data - Admin</title>
...
<body class="bg-slate-100 font-sans">
    ...
    <div class="container mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-3xl font-bold mb-6 text-slate-800">Kaprang Measuring Instrument Data (Admin)</h1>
            ...
            <table class="w-full">
                <thead class="bg-slate-800 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider whitespace-nowrap">Tool Name</th>
