...
<head>
    ...
    <title>Kania Welding Machine Data - Admin</title>
...
<body class="bg-slate-100 font-sans">
    ...
    <div class="container mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-3xl font-bold mb-6 text-slate-800">Kania Welding Machine Data (Admin)</h1>
        ...
        {{-- Data Table: Removed overflow-x-auto to prevent scrolling --}}
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <table class="w-full table-auto">
                <thead class="bg-slate-800 text-white">
                    <tr>
                        {{-- REFINED: Removed whitespace-nowrap and adjusted padding to allow wrapping --}}
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">No</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Codification</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Machine Name</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Brand / Type</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Serial Number</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Range</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Date</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-left text-xs font-semibold uppercase tracking-wider">Due Date</th>
                        ...
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-center text-xs font-semibold uppercase tracking-wider">Status</th>
                        <th class="px-4 py-3 border-b-2 border-slate-700 text-center text-xs font-semibold uppercase tracking-wider">Actions</th>
                    </tr>
                </thead>
                <tbody class="text-gray-700 text-sm">
                    @forelse($data as $row)
                        ...
                        <tr class="{{ $rowClass }} transition-colors duration-200 align-middle">
                            ...
                            <td class="px-4 py-4 border-b border-gray-200 break-words">{{ $row->no_seri }}</td>
                            <td class="px-4 py-4 border-b border-gray-200">{{ $row->range_alat }}</td>
                            <td class="px-4 py-4 border-b border-gray-200">{{ $row->tgl_kalibrasi }}</td>
                            <td class="px-4 py-4 border-b border-gray-200">{{ $row->kalibrasi_selanjutnya }}</td>
