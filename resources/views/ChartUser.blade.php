...
<script>
    ...
    fetch("{{ route('chart.data') }}")
        ...
        .then(data => {
            ...
            new Chart(document.getElementById('chartAlatUkurVsDone'), {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [
            ...
            new Chart(document.getElementById('chartAlatUkurVsRecal'), {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [
            ...
            new Chart(document.getElementById('chartMesinLasVsDone'), {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [
            ...
            new Chart(document.getElementById('chartMesinLasVsRecal'), {
                type: 'bar',
                data: {
                    labels: labels,
                    datasets: [
